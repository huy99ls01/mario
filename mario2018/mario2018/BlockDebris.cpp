...
void BlockDebris::Draw(SDL_Renderer* rR) {
	CCore::getMap()->getBlock(CCore::getMap()->getLevelType() == 0 ? 64 : 51)->getSprite()->getTexture()->Draw(rR, vPositionL->getX() + (int)CCore::getMap()->getXPos(), vPositionL->getY(), bRotate);
	CCore::getMap()->getBlock(CCore::getMap()->getLevelType() == 0 ? 64 : 51)->getSprite()->getTexture()->Draw(rR, vPositionR->getX() + (int)CCore::getMap()->getXPos(), vPositionR->getY(), bRotate);
	CCore::getMap()->getBlock(CCore::getMap()->getLevelType() == 0 ? 64 : 51)->getSprite()->getTexture()->Draw(rR, vPositionL2->getX() + (int)CCore::getMap()->getXPos(), vPositionL2->getY(), bRotate);
	CCore::getMap()->getBlock(CCore::getMap()->getLevelType() == 0 ? 64 : 51)->getSprite()->getTexture()->Draw(rR, vPositionR2->getX() + (int)CCore::getMap()->getXPos(), vPositionR2->getY(), bRotate);
}
